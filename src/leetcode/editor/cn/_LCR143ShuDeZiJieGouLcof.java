...
public class _LCR143ShuDeZiJieGouLcof {
    ...
    class Solution {
         ...
         * 有三种情况可以认为B是A序列的子序列
         * 1. B是否是A的子序列，即recur(A, B)，
         * 2. B是否是A.left的子序列，即isSubStructure(A.left, B)
         * 3. B是A.right的子序列，即isSubStructure(A.right, B)
         * 其中recur是判断A树是否包含B树
         * 1. 当B==null时，不管A是否已经到叶子节点的下一层，都认为包含，返回true
         * 2. 当A==null && B != null时，A肯定不包含B，返回false
         * 3. 当且仅当 A.val == B.val && A 的左子树包含B的左子树 && A的右子树包含B的右子树才可以
         *
         *
         */
